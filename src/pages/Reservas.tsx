...
export const Reservas: React.FC = () => {
  ...
  const getSlotClass = (canchaid: string, hora: string): string => {
    ...
    } else if (reserva.metodo_pago === 'pendiente') {
      colorClass = 'bg-yellow-200';
    } else if (reserva.estado === 'confirmada' && reserva.metodo_pago !== 'pendiente') {
      colorClass = 'bg-green-200';
    } else {
      colorClass = colorClass.replace('500', '200');
    }
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between p-4 bg-white rounded-lg shadow">
        <button
          onClick={() => setSelectedDate(dateUtils.addDays(selectedDate, -1))}
                    ...
                    <div className="flex items-center space-x-4">
                      ...
                      <div>
                        <div className="font-medium text-gray-900">
                          {reserva.cliente_nombre} - {cancha?.nombre}
                        </div>
